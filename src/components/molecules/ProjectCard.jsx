...
const ProjectCard = ({ image, title}) => {
  return (
    <Link to={"/detail"} className='hover:scale-105 transition-transform duration-300 ease-in-out'>
      ...
      <div className="max-w-sm border rounded-lg border-sky-400 shadow-2xl h-full bg-sky-100/80 backdrop-blur-3xl">
        <div className="p-1">
            ...
            <h4 className="text-base md:text-lg lg:text-xl font-bold tracking-tight text-sky-700 text-center mt-2 p-2"> {/* Tambahkan text-center dan p-2 */}
              {title}
            </h4>
        </div>
      </div>
